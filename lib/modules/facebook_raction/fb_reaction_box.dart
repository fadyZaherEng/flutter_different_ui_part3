...
//اهم متغير البعرضه الشايل ال اندكس بتاع انهى ايموجي تم اختياره عشان
// لما يتحفظ في الداتا بيز ولما اخده بعمل سيت لل اندكس بقيمتة عشان يتعرض عاى الايموجي المختارها
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
  ...
  String getTextBtn() {
    print('Indexxxxxxxxxxxxx $whichIconUserChoose');
    if (isDragging) {
      return 'Like';
    }
